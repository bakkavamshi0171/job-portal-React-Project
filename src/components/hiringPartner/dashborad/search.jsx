...
//     //   // return job.jobTitle.toLowerCase().trim().split("-").join().includes(search.toLowerCase().trim().split("-").join());
//     //   let x = job.jobTitle.toLowerCase().trim();
//     //   let y = search.toLowerCase().trim();
//     //   if(x.includes("-")){
//     //     return x.split("-").join().includes(y);
//     //   }else{
//     //     return x.includes(y);
//     //   }
//     // });
...
//     return Object.entries(jobData).filter(([key, job]) => {
//       const normalizedTitle = job.jobTitle
//         .toLowerCase()
//         .trim()
//         .replace(/-/g, "");
